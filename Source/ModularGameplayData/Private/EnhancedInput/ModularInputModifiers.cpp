...
//////////////////////////////////////////////////////////////////////
// UModularInputModifierDeadZone

FInputActionValue UModularInputModifierDeadZone::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	EInputActionValueType ValueType = CurrentValue.GetValueType();
	ULocalPlayer* LocalPlayer = ModularInputModifiersHelpers::GetLocalPlayer(PlayerInput);
...
FLinearColor UModularInputModifierDeadZone::GetVisualizationColor_Implementation(FInputActionValue SampleValue, FInputActionValue FinalValue) const
{
...
//////////////////////////////////////////////////////////////////////
// UModularInputModifierGamepadSensitivity

FInputActionValue UModularInputModifierGamepadSensitivity::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	//const EModularGamepadSensitivity Sensitivity = (TargetingType == EModularTargetingType::Normal) ? Settings->GetGamepadLookSensitivityPreset() : Settings->GetGamepadTargetingSensitivityPreset();
...
//////////////////////////////////////////////////////////////////////
// UModularInputModifierAimInversion

FInputActionValue UModularInputModifierAimInversion::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	ULocalPlayer* LocalPlayer = ModularInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (!LocalPlayer)
	{
