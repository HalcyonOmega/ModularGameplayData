...
#include "ModularInputUserSettings.generated.h"

/**
 * Custom settings class for any input related settings for the Modular game.
 * This will be serialized out at the same time as the Modular Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class MODULARGAMEPLAYDATA_API UModularInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class MODULARGAMEPLAYDATA_API UModularPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
